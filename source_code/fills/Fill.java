...
public class Fill extends AbstractMessage
{
	...
	{
		return String.format("%s(%s,%s,%s,%s)", Fill.class.getName(), this.getClientId().toString(),
				this.getCounterpartyId().toString(), this.getClientOrderId().toString(), this.getQuantity().toString());
	}
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof Fill))
			return false;
		Fill fill = (Fill) o;
		return ((this.getClientId().equals(fill.getClientId()))
