...
/**
 * Class that represents a price in dollars multiplied by 10000. This is a
 * common way to avoid round-off. This class will throw an exception if the
...
public class Price implements Comparable<Price>
{
	...
	/**
	 * Create a price from a long value of dollars scaled up by 10000.
	 * 
	...
	{
		return _dollarsTimesTenThousand;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + (int) (_dollarsTimesTenThousand ^ (_dollarsTimesTenThousand >>> 32));
		return result;
	}
	...
	{
		return String.format("%s(%d)", this.getClass().getName(), this.getValue());
	}
