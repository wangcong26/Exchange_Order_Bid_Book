...
/**
 * This class represents a message to the client telling the client that the
 * client's sweeping order was not completely filled and was made into a resting
 * order that is now part of the appropriate book.
 */
public class RestingOrderConfirmation extends AbstractMessage
{
	...
	/**
	 * Create a new RestingOrderConfirmation and save a reference to the resting
	 * order
	 * 
	 * @param restingOrder The resting order to which this message makes reference
	 */
	...
	{
		return String.format("%s(%s)", this.getClass().getName(), this.getRestingOrder().toString());
	}
	...
	public boolean equals(Object o)
	{
		...
		return ((this.getRestingOrder().equals(roc)) && (this.getClientId().equals(roc.getClientId()))
