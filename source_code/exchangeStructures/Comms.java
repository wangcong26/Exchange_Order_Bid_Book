...
/**
 * This class simulates a communications link between the clients and the
 * exchange. Messages that it can send to the client include Fill, Cancelled,
 * CancelRejected, and RestingOrderConfirmation. Nothing as actually sent to the
 * client. All messages are just appended to lists that are available for
 * verification of functionality for testing purposes.
 *
 */
public class Comms
{
	...
	/**
	 * Simulated telling client that client's resting or sweeping order has been
	 * filled
	 * 
	...
	/**
	 * Simulates telling client that client's sweeping order has become a resting
	 * order
	 * 
	...
	/**
	 * Simulates sending a message to the client telling the client that the
	 * client's cancel message was rejected
	 * 
	...
	/**
	 * Simulates sending a cancelled message to the client. The cancelled message
	 * tells the client that the order the client wanted to cancel was cancelled.
	 * 
	 * @param cancelled Message that tells client that the client's order was
	 *                  cancelled
	 */
	public void cancelled(Cancelled cancelled)
	{
		_canceledMsgs.addLast(cancelled);
	}
	...
	{
		return _rejectedCancels;
	}

	public LinkedList<Cancelled> getCancelationConfirmations()
	{
		return _canceledMsgs;
	}
