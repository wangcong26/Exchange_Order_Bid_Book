...
public class Test_Exchange_p7 extends junit.framework.TestCase
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		System.out.println("Part 6 test ");
		// #6 Client 5
		...
		SweepingOrder sweepingOrder5 = new SweepingOrder(clientId5, clientOrderId5, marketId5, side5, quantity5,
				price5);
		...
		assertTrue(exchange.getMarket(new MarketId("IBM")).getOfferBook().getPriceLevels().get(new Price(1260000L))
				.getOrders().size() == 1);
		assertTrue(exchange.getMarket(new MarketId("IBM")).getBidBook().getPriceLevels().get(new Price(1250000L))
				.getOrders().size() == 1);
		...
		System.out.println("Current Bidbook has Pricelevel: ");
		Map<Price, PriceLevel> currentPriceLevel6 = new TreeMap<>();
		currentPriceLevel6 = exchange.getMarket(marketId0).getBidBook().getPriceLevels();
		for (Map.Entry<Price, PriceLevel> entry : currentPriceLevel6.entrySet())
		{
			System.out.println("Key=" + entry.getKey().getValue() + ", Value=" + entry.getValue());
		}
		
		System.out.println("Current Offerbook has Pricelevel: ");
		Map<Price, PriceLevel> currentPriceLevel6b = new TreeMap<>();
		currentPriceLevel6b = exchange.getMarket(marketId0).getOfferBook().getPriceLevels();
		for (Map.Entry<Price, PriceLevel> entry : currentPriceLevel6b.entrySet())
		{
			System.out.println("Key=" + entry.getKey().getValue() + ", Value=" + entry.getValue());
		}
		
		System.out.println("End of part 6 test ");
		System.out.println();

		
///////////////////////////////////////////////////////////////////////////////////////////////////////////

		System.out.println("Part 7 test ");
		// #7 Cancel an order
		// We will now test canceling an order
		exchange.cancel(new Cancel(clientId4, clientOrderId4));
		assertTrue(exchange.getOrder(clientOrderId4) == null);
		assertTrue(exchange.getComms().getCancelationConfirmations().getLast().getClientId().equals(clientId4));
		...
		System.out.println("Current bidbook has one priceLevel but quantity==0.");
		Map<Price, PriceLevel> currentPriceLevel7 = new TreeMap<>();
		currentPriceLevel7 = exchange.getMarket(marketId0).getBidBook().getPriceLevels();
		for (Map.Entry<Price, PriceLevel> entry : currentPriceLevel7.entrySet())
		{
			System.out.println("Key=" + entry.getKey().getValue() + ", Value=" + entry.getValue());
		}
		...
		// So this sell order will not have a match in the bid book and it will be stored in the offerbook.
		SweepingOrder sweepingOrder6 = new SweepingOrder(new ClientId("Tom"), new ClientOrderId("12345"),
				new MarketId("IBM"), Side.SELL, new Quantity(100), new Price(1200000));
		...
		System.out.println("This order is added to the exchange:");
		System.out.println(exchange.getOrder(new ClientOrderId("12345")));
		...
		System.out.println("Current offerbook has two pricelevels");
		Map<Price, PriceLevel> currentPriceLevel7b = new TreeMap<>();
		currentPriceLevel7b = exchange.getMarket(marketId0).getOfferBook().getPriceLevels();
		for (Map.Entry<Price, PriceLevel> entry : currentPriceLevel7b.entrySet())
		{
			System.out.println("Key=" + entry.getKey().getValue() + ", Value=" + entry.getValue());
		}
		
		System.out.println("End of part 7 test ");
