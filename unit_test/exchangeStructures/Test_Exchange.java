...
public class Test_Exchange extends junit.framework.TestCase
{
	...
	public void test1() throws Exception
	{
		...
		SweepingOrder sweepingOrder1 = new SweepingOrder(clientId1, clientOrderId1, marketId1, side1, quantity1,
				price1);
		...
		SweepingOrder sweepingOrder2 = new SweepingOrder(clientId2, clientOrderId2, marketId2, side2, quantity2,
				price2);
		...
		exchange.cancel(new Cancel(clientId4, clientOrderId4));
		assertTrue(exchange.getComms().getCancelRejections().getLast()
				.equals(new CancelRejected(clientId4, clientOrderId4)));
